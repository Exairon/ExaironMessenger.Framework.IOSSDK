...
//
//  Created by Exairon on 12.04.2023.
//

import UIKit

class PhoneFormFieldView: UIView {
    
    @IBOutlet weak var mainView: UIView!
    @IBOutlet weak var labelView: UILabel!
    @IBOutlet weak var counrtyCodeField: UITextField!
    ...
    func initialView() {
        ...
        counrtyCodeField.placeholder = "+.."
        counrtyCodeField.backgroundColor = UIColor(hexString: "#1E1E1E10")
        counrtyCodeField.layer.cornerRadius = 10
    ...
    func commonInit() {
        ...
        let viewFromXib = bundle.loadNibNamed("PhoneFormFieldView", owner: self, options: nil)![0] as! UIView
